...
// Progress-based speed ramp: 1.0x → 1.3x over TOTAL_QUESTIONS

// Keep crash scroll proportional to current speed
const denom = Math.max(1, TOTAL_QUESTIONS - 1);
const percentComplete = Math.min(1, Math.max(0, gs.questionsAnswered / denom));
const dynamicSpeed = SCROLL_SPEED * (1 + percentComplete * 0.3);
        gs.scrollX += dynamicSpeed * 0.3;
        return;
      }



      gs.scrollX += dynamicSpeed;
